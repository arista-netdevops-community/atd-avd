...
| Ethernet2 | P2P_LINK_TO_SPINE1_Ethernet4 | 1500 | routed | access | - | - | - | 172.30.255.9/31 | - | - |
| Ethernet3 | P2P_LINK_TO_SPINE2_Ethernet4 | 1500 | routed | access | - | - | - | 172.30.255.11/31 | - | - |
| Ethernet4 | host2_Eth1 | *1500 | *switched | *access | *110 | - | - | - | 4 | active |
| Ethernet5 | host2_Eth2 | *1500 | *switched | *access | *110 | - | - | - | 4 | active |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | Global Routing Table | 192.0.255.5/32 |
...
| 172.30.255.8 | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.30.255.10 | Inherited from peer group IPv4-UNDERLAY-PEERS |
