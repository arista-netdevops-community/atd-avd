...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management0 | oob_management | MGMT | 192.168.0.12/24 | 10.255.0.1 |

IPv6

| Management Interface | description | VRF | IPv6 Address | IPv6 Gateway |
| -------------------- | ----------- | --- | ------------ | ------------ |
| Management0 | oob_management | MGMT | not configured  | not configured |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | MLAG_PEER_leaf2_Ethernet1 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 1 | active |
| Ethernet2 | P2P_LINK_TO_SPINE1_Ethernet2 | 1500 | routed | access | - | - | - | 172.31.255.1/31 | - | - |
| Ethernet3 | P2P_LINK_TO_SPINE2_Ethernet2 | 1500 | routed | access | - | - | - | 172.31.255.3/31 | - | - |
| Ethernet4 | host1_Eth1 | *1500 | *switched | *access | *110 | - | - | - | 4 | active |
| Ethernet5 | host1_Eth2 | *1500 | *switched | *access | *110 | - | - | - | 4 | active |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --------------------- ! ------------------ | ------- | -------- | --- | ---------- | ------------ |
| Port-Channel1 | MLAG_PEER_leaf2_Po1 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - | - | - | - | - |
| Port-Channel4 | host1_PortChanne1 | 1500 | switched | access | 110 | - | - | - | 4 | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | Global Routing Table | 192.0.255.3/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | Global Routing Table | 192.0.254.3/32 |
