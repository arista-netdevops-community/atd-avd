...
| Ethernet4 | DC1-L2LEAF1A_Ethernet1 | *1500 | *switched | *trunk | *110-112,120-121,130-131 | - | - | - | 4 | active |
| Ethernet5 | DC1-L2LEAF1A_Ethernet3 | *1500 | *switched | *trunk | *110-112,120-121,130-131 | - | - | - | 4 | active |
...
!
interface Ethernet5
   description DC1-L2LEAF1A_Ethernet3
   channel-group 4 mode active
```
