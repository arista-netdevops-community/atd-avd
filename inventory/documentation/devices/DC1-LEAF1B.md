...
| Ethernet4 | DC1-L2LEAF1A_Ethernet2 | *1500 | *switched | *trunk | *110-112,120-121,130-131 | - | - | - | 4 | active |
| Ethernet5 | DC1-L2LEAF1A_Ethernet4 | *1500 | *switched | *trunk | *110-112,120-121,130-131 | - | - | - | 4 | active |
...
!
interface Ethernet5
   description DC1-L2LEAF1A_Ethernet4
   channel-group 4 mode active
```
